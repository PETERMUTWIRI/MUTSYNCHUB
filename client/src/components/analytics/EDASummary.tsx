...
export default function EDASummary({ stats }: EDASummaryProps) {
  const summaryItems = [
  ...
  return (
    <div className="rounded-2xl bg-gradient-to-br from-slate-800/70 to-indigo-900/80 p-6 shadow flex flex-col gap-2">
